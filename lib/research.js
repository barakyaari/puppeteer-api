...
const researchByNameLogic = async (fullName) => {
    ...
    try {
        ...
        throw new Error('Failed to infer details using GPT', error.message);
    }
    ...
    try {
        ...
        throw new Error('Failed to perform Google search and scrape', error.message);
    }
    ...
    try {
        ...
        throw new Error('Failed to analyze combined data', error.message);
    }
};
